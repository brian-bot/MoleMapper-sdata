...
baseWiki <- paste0("-----\n### Seeding a community in Melanoma research\nThere are now ", as.integer(nrow(theseOnes)), " approved projects leveraging the data shared broadly by MoleMapper study participant. It is the hope of Sage Bionetworks that by participants making their data available to qualified researchers worldwide, that we can seed a community who will work together and share insights into skin health. Synapse Certified Users with verified profiles may request access to the MoleMapper data resource for research to benefit human health. Due to the sensitive nature of the images, additional steps are necessary to access those data. Below is a listing of all projects proposed to leverage the MoleMapper data. Take a look at what others are proposing to do, and reach out to any who you may be interested in working with!\n-----\n")
fullWiki <- baseWiki
...
thisWiki <- synGetWiki(synGet("syn5576734"), "395970")
